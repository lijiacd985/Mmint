...
def run(parser):
    ...
    #	y_smooth2 = spline(x_trans[0], y_trans[1], x_smooth)
        ...
        #ax1.set_title(args.label[i])
    	    plt.axvline(x_trans[0][0]+3000,color='red',linewidth=2,linestyle='dashed')
            plt.axvline(x_trans[0][-1]-3000,color='red',linewidth=2,linestyle='dashed')
